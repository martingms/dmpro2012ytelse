...
add wave -noupdate -expand -group 1 -expand -group 4 -label swap /tb_simd_architecture/uut/simd_arr/row(2)/col(4)/edge/e/node_s_reg/s_swap
add wave -noupdate -expand -group 1 -expand -group 4 -label step /tb_simd_architecture/uut/simd_arr/row(2)/col(4)/edge/e/node_s_reg/s_step
add wave -noupdate -expand -group 1 -expand -group 4 -label s_res /tb_simd_architecture/uut/simd_arr/row(2)/col(4)/edge/e/node_s_reg/s_res
add wave -noupdate -expand -group 1 -expand -group 4 -label s_new /tb_simd_architecture/uut/simd_arr/row(2)/col(4)/edge/e/node_s_reg/s_new
add wave -noupdate -expand -group 1 -expand -group 4 -label s_in /tb_simd_architecture/uut/simd_arr/row(2)/col(4)/edge/e/node_s_reg/s_in
add wave -noupdate -expand -group 1 -expand -group 4 -label tmp_s /tb_simd_architecture/uut/simd_arr/row(2)/col(4)/edge/e/node_s_reg/tmp_s
add wave -noupdate -expand -group 1 -expand -group 4 -label s_out /tb_simd_architecture/uut/simd_arr/row(2)/col(4)/edge/e/node_s_reg/s_out
...
WaveRestoreCursors {{Cursor 1} {485666 ps} 0}
...
update
WaveRestoreZoom {317040 ps} {498883 ps}
