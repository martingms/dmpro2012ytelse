...
add wave -noupdate /tb_array/uut/data_out
add wave -noupdate -radix hexadecimal -expand -subitemconfig {/tb_array/uut/s_data(4) {-radix hexadecimal} /tb_array/uut/s_data(3) {-radix hexadecimal} /tb_array/uut/s_data(2) {-radix hexadecimal} /tb_array/uut/s_data(1) {-radix hexadecimal} /tb_array/uut/s_data(0) {-radix hexadecimal}} /tb_array/uut/s_data
...
update
WaveRestoreZoom {155243 ps} {357947 ps}
