...
to read data instructions as well. All these different parts require
relatively much memory, and they are all frequently accessed. Therefore it would
be favourable to have them as separate components so that memory accesses can be
parallelised.
