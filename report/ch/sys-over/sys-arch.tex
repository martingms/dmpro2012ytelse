...
with data it should process. As we were unsure of what would be the easiest to \TODO{This is not true. Redundancy was the main reason for having multiple IO. Using the serial port for data transfer would be a last resort}
