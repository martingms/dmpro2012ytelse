...
this, we can assume that errors occuring when connecting different components is
...
favourable to have them as separate components so that memory access can be
parallelised.
