...
node. \TODO{This is very illustrative, but not technically correct. Is that an
  issue?} When every \ac{SIMD} node has data to work with, every node ``picks
...
takes the finished result and puts it back into the data memory. \TODO{I am not
  100\% that this is right. Could someone confirm this?} Note that Figure
