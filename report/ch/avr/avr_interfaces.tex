...
the the microcontroller used in the SCU, the AVR AT32UC3A0. Also included are specifics in regard to what choices
were made in terms of AVR specific hardware. 

Trying to design and plan the hardware associated with the AVR we quickly realized that there were some components that required more planning and more careful placing than the rest. Mostly this was because they either had to be connected to special hardware (spesific pins) or needed physical proximity in order to be as effective as possible. To mention some of these:
...
design we encountered a few problemswith this, mostly in
regard to performance. This problem is elaborated in the \ac{SD} card implementation
section. \TODO {fix reference}
