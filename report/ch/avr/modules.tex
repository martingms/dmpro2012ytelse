...
\TODO{FPGA må endres til LENA i figuren}
...
\item[RS232] A protocol for communication with a PC over the serial port. Very
  ...
  board.\TODO{Fix the reference. It currently floats in the air}
...
\item[JTAG] JTAG is an interface used to connect the AVR to a
