...
order to be as effective as possible. To mention some of these: \TODO{physcal proximity, really?}
...
Our AVR also supports \ac{USB}. We decided to map up the \ac{USB} even though we were doubtful we would have much use for it, due to both having \ac{SD} card and serial for debugging purposes\TODO{This sentence needs reworking}. This feature therefore was given a low priority and was not implemented in the final design due to time constraints.
