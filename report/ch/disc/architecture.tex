...
SD card in blocks.\CHECK{(?)} Another argument for adding this memory was to
...
if need be.\CHECK{What has headers to do with redundancy? It's just
  convenience.} Luckily, both SD card and and our own VGA worked, and we
therefore had no need of the redundancies. \TODO{Motivate the need for the
  redundancies as well, instead of just saying they were unneccesary}
