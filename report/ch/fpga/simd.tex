...
architecture\TODO{architecture/machine question again} does.
...
from the node are all labeled with \TODO{Again, colour print}red labels. In this
section we will refer to this image when explaining the different components.

\TODO{Fix signal labels in architecture image to differentiate between input,
  output and instruction. Jahre nevner at det må tydeligjøres hva
  som er busser og hva som er signaler}
...
\TODO{List the 8 ALU functions somewhere with their binary representations.}
