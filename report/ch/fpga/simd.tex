...
\TODO{Fix signal labels in architecture image to differentiate between input, output and instruction}
...
\TODO{This paragraph is kind of VHDL implementation specific. Should we keep it?}
