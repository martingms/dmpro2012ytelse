...
signals\TODO{Må skrives ut i farge om vi skal ha dette med} in Figure
...
\TODO{Jahre syntes Figur \ref{fig:fpga-ctrl-core} ble for liten}
...
| the S register\TODO{Second time S register is introduced.} | that is reserved
...
along the columns and rows of the current slice\TODO{Why not use the commonly
  used stride? It is already defined, and is probably known to the reader} of
the data. These parameters allow flexibility in how the data slices are laid out
in memory.
